...
namespace RLEngine.Support.Palette
{
	public static class Palette
	{
		...
		public static Dictionary<string, RLColor> colors = new Dictionary<string, RLColor>
		{
			...
			{"azure 1 (azure)",				new RLColor(240, 255, 255)},
			{"azure 2",						new RLColor(224, 238, 238)},
			{"azure 3",						new RLColor(193, 205, 205)},
			{"azure 4",						new RLColor(131, 139, 139)},
			{"lightcyan 1 (lightcyan)",		new RLColor(224, 255, 255)},
			{"lightcyan 2",					new RLColor(209, 238, 238)},
			{"lightcyan 3",					new RLColor(180, 205, 205)},
			{"lightcyan 4",					new RLColor(122, 139, 139)},
			{"paleturquoise 1",				new RLColor(187, 255, 255)},
			{"paleturquoise 2",				new RLColor(174, 238, 238)},
			{"paleturquoise 3",				new RLColor(150, 205, 205)},
			{"paleturquoise 4",				new RLColor(102, 139, 139)},
			...
			{"cyan / aqua* cyan / aqua*",	new RLColor(  0, 255, 255)},
			{"cyan 2",						new RLColor(  0, 238, 238)},
			{"cyan 3",						new RLColor(  0, 205, 205)},
			{"cyan 4 (darkcyan)",			new RLColor(  0, 139, 139)},
			{"teal* teal*",					new RLColor(  0, 128, 128)},
			...
			{"coldgrey        coldgrey",	new RLColor(128, 138, 135)},
			{"turquoiseblue",				new RLColor(  0, 199, 140)},
			{"aquamarine 1",				new RLColor(127, 255, 212)},
			{"aquamarine 2",				new RLColor(118, 238, 198)},
			{"aquamarine 3",				new RLColor(102, 205, 170)},
			{"aquamarine 4",				new RLColor( 69, 139, 116)},
			{"mediumspringgreen",			new RLColor(  0, 250, 154)},
			{"mintcream",					new RLColor(245, 255, 250)},
			{"springgreen",					new RLColor(  0, 255, 127)},
			{"springgreen 1",				new RLColor(  0, 238, 118)},
			{"springgreen 2",				new RLColor(  0, 205, 102)},
			{"springgreen 3",				new RLColor(  0, 139,  69)},
			{"mediumseagreen mediumseagreen",				new RLColor( 60, 179, 113)},
			{"seagreen 1",				new RLColor( 84, 255, 159)},
			{"seagreen 2",				new RLColor( 78, 238, 148)},
			{"seagreen 3",				new RLColor( 67, 205, 128)},
			{"seagreen 4 (seagreen)",				new RLColor( 46, 139,  87)},
			{"emeraldgreen emeraldgreen",				new RLColor(  0, 201,  87)},
			{"mint mint",				new RLColor(189, 252, 201)},
			{"cobaltgreen cobaltgreen",				new RLColor( 61, 145,  64)},
			{"honeydew 1 (honeydew)",				new RLColor(240, 255, 240)},
			{"honeydew 2",				new RLColor(224, 238, 224)},
			{"honeydew 3",				new RLColor(193, 205, 193)},
			{"honeydew 4",				new RLColor(131, 139, 131)},
			{"darkseagreen darkseagreen",				new RLColor(143, 188, 143)},
			{"darkseagreen 1",				new RLColor(193, 255, 193)},
			{"darkseagreen 2",				new RLColor(180, 238, 180)},
			{"darkseagreen 3",				new RLColor(155, 205, 155)},
			{"darkseagreen 4",				new RLColor(105, 139, 105)},
			{"palegreen palegreen",				new RLColor(152, 251, 152)},
			{"palegreen 1",				new RLColor(154, 255, 154)},
			{"palegreen 2 (lightgreen)",				new RLColor(144, 238, 144)},
			{"palegreen 3",				new RLColor(124, 205, 124)},
			{"palegreen 4",				new RLColor( 84, 139,  84)},
